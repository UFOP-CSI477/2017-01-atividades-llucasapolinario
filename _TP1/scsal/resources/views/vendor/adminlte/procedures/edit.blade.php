        ...
        <fieldset>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              ...
              <input type="text" name="name" readonly="readonly" value="{{ $procedure->name }}" class="form-control">
              @endif
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="number" step="0.01" name="price" value="{{ $procedure->price }}" class="form-control">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="number" name="user_id" readonly="readonly" value="{{$procedure->user_id}}" class="form-control">
            </div>
          </div>
